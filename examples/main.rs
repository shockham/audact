...
fn main() {
    ...
    //lead
    audact.voice_channel(notes::C3, Wave::Saw, (0f32, 0.8f32), vec![0,4,8,12]).unwrap();
    audact.voice_channel(notes::D3, Wave::Saw, (0f32, 0.8f32), vec![1,5,9,13]).unwrap();
    audact.voice_channel(notes::F3, Wave::Saw, (0f32, 0.8f32), vec![2,3,6,7,10,11,14,15]).unwrap();
